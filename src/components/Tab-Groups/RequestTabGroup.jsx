...
import TokenPane from '../Panes/Token/TokenPane';
...
export default function RequestTabGroup({
  ...
  return (
    <Tabs forceRenderTabPanel selectedTabClassName="border-b-2 text-orange-600">
      ...
      {requestTabs.map((tab) => (
        <TabPanel
          className="react-tabs__tab-panel px-4 py-4 rounded-b-lg border border-t-0 border-gray-300 h-[18vh] overflow-scroll"
          key={tab.slug}
        >
          <tab.panel
